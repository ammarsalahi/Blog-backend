...
class UserManager(BaseUserManager):
    ...
    def create_user(self, username, email, is_superuser, is_staff, full_name=None, password=None):
        if not username:
    ...
    def create_publicuser(self, email, full_name, username=None,password=None):
        return self.create_user(
